...
const useStyles = makeStyles((theme: Theme) => ({
  networkTile: {
    backgroundImage: `linear-gradient(-30deg, ${theme.palette.primary[800] + '05'} 0%, ${theme.palette.primary[800] + 'ff'} 100%)`,
...
function NetworksModal(props: Props) {
  ...
  return (
    <div className={classes.networkTile}>
      <img className={classes.networkIcon} src={NoNetworkIcon} alt="Select Network" />
