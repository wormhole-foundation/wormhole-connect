      ...
      <FormContent>
        ...
        <Box sx={styles.body}>
          ...
          <p>
            ...
            parties; (c) you may not have ready access to assets; and (d) you
            may lose some or all of your tokens or other assets. You agree that
            you will have no recourse against anyone else for any losses due to
            the use of the SDK or the Wormhole protocol. For example, these
            losses may arise from or relate to: (i) incorrect information; (ii)
            software or network failures; (iii) corrupted cryptocurrency wallet
            files; (iv) unauthorized access; (v) errors, mistakes, or
            inaccuracies; or (vi) third-party activities.
          </p>
          <p>
            You must read this Agreement carefully as it governs your use of the
            Services. By accessing or using any of the Services, you (on behalf
            of yourself or the entity that you represent) signify that you have
            read, understand, and agree to be bound by, this Agreement and our
            Privacy Policy in its entirety, and you represent and warrant that
            you have the willingness, right, authority, and capacity lawfully to
            enter into this Agreement (on behalf of yourself or the entity that
            you represent). If you do not agree, you are not authorized to
            access or use any of our Services and should not use our Services.
          </p>
          <p>
            To access or use any of our Services, you must be able to form a
            legally binding contract with us. Accordingly, you represent that
            you are at least the age of majority in your jurisdiction (e.g., 18
            years old in the United States) and have the full right, power, and
          ...
          <p>
            ...
            any of our Services will fully comply with all applicable laws and
            regulations, and that you will not access or use any of our Services
          ...
          <p>
            ...
            Services are only available to you — and you should only access any
            of our Services — if you agree completely with these terms.
          </p>
          <ol>
            <li>
              ...
              <ol type="a">
                <li>
                  ...
                  sole discretion, to modify this Agreement from time to time.
                  If we make any material modifications, we will notify you by
                  updating the date at the top of the Agreement and by
                  maintaining a current version of the Agreement at ${termsUrl}
                  /terms-of-use. All modifications will be effective when they
                  are posted, and your continued accessing or use of any of the
                  Services will serve as confirmation of your acceptance of
                  those modifications. If you do not agree with any
                ...
                <li>
                  ...
                  rights, which do not constitute obligations of ours: (a) with
                  or without notice to you, to modify, substitute, eliminate or
                  add to any of the Services; (b) to review, modify, filter,
                  disable, delete, and remove any and all content and
            ...
            <li>
              ...
              <ol type="a">
                <li>
                  ...
                  <ol type="i">
                    <li>
                      ...
                      thereof), are owned by us, our licensors or other
                      providers of such material and are protected by copyright,
                      trademark, patent, trade secret, and other intellectual
                      property or proprietary rights laws. Neither the Agreement
                      (nor your use of the Services) transfers to you or any
                      third party any rights, title, or interest in or to such
                      intellectual property rights, except as indicated
                      otherwise.
                    </li>
                    <li>
                      ...
                      solely in accordance with this Agreement. You agree that
                      you will not use, modify, distribute, tamper with, reverse
                ...
                <li>
                  ...
                  regarding the Services (“Feedback"), you hereby assign to us
                  all rights in such Feedback and agree that we have the right
                  to use and fully exploit such Feedback and related information
                  in any manner we deem appropriate. Any Feedback you provide
                  will be treated as non-confidential and non-proprietary, and
                  we will be entitled to the unrestricted use and dissemination
                  of such Feedback for any purpose, commercial or otherwise,
            ...
            <li>
              ...
              <ol type="a">
                <li>
                  ...
                  purposes and in accordance with the Agreement. You agree not
                  to:
                  <ol type="i">
                    <li>
                    ...
                    <li>
                      ...
                      the proper working of any Service;
                    </li>
                    <li>
                      attempt to probe, scan or test the vulnerability of the
                      Services, or otherwise seek to interfere with or
                      compromise the integrity, security, or proper functioning
                      of the Services;
                    </li>
                    <li>
                      attempt to interfere with the proper working of the
                      Services, or interfere with, damage, or disrupt any parts
                      of the Services, the server(s) on which the Services is
                ...
                <li>
                  ...
                  <ol type="i">
                    <li>
                      ...
                      and interactions with the Protocol, including all of your
                      transfers of digital assets; all transactions you submit
                      to the Protocol are considered unsolicited, which means
                      that they are solely initiated by you;
                    </li>
                    <li>
                      to the fullest extent not prohibited by applicable laws,
                    ...
                    <li>
                      ...
                      digital assets at any time; we accept no responsibility
                      for, or liability to you, in connection with your use of a
                      wallet and make no representations or warranties regarding
                      how any of our Services will operate with any specific
                      wallet; likewise, you are solely responsible for any
                      associated wallet and we are not liable for any acts or
                      omissions by you in connection with or as a result of your
                      wallet being compromised; and
                    </li>
                    <li>
                      Transactions that take place on a blockchain network
                      require the payment of transaction fees to the validators
                      or node operators of the relevant network ("Gas Fees");
                      you will be solely responsible to pay the Gas Fees for any
                      transaction that you initiate via any of our Services.
                    </li>
                  </ol>
                </li>
                <li>
                  Release of Claims. You expressly agree that you assume all
                  risks in connection with your use of the Services. You further
                  expressly waive and release us, as well as its affiliates and
                  service providers, and each of their respective past, present
                  and future officers, directors, members, employees,
                  consultants, representatives and agents, and each of their
                  respective successors and assigns from any and all liability,
                  claims, causes of action, or damages arising from or in any
                  way relating to your use of the Services.
                </li>
              </ol>
            </li>
            <li>
              ...
              <ol type="a">
                <li>
                  ...
                  A PARTICULAR PURPOSE. YOU ACKNOWLEDGE AND AGREE THAT YOUR USE
                  ...
                  ELEMENTS. NO ADVICE, INFORMATION, OR STATEMENT THAT WE MAKE
                  SHOULD BE TREATED AS CREATING ANY WARRANTY CONCERNING ANY OF
                  OUR SERVICES.
                </li>
                <li>
                  SIMILARLY, THE PROTOCOL IS PROVIDED "AS IS", AT YOUR OWN RISK,
                  AND WITHOUT WARRANTIES OF ANY KIND. WE DO NOT PROVIDE, OWN OR
                  CONTROL THE PROTOCOL, WHICH OPERATES AUTONOMOUSLY ON
                  BLOCKCHAINS SUBJECT TO GOVERNANCE BY A DECENTRALIZED SET OF
                  VALIDATORS. NO DEVELOPER OR ENTITY INVOLVED IN CREATING THE
                  ...
                  TOKENS, OR ANYTHING ELSE OF VALUE. WE DO NOT ENDORSE,
                  GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY ADVERTISEMENTS,
                  OFFERS, OR STATEMENTS MADE BY THIRD PARTIES CONCERNING ANY OF
                  OUR SERVICES.
                </li>
                <li>
                  Information Only. You agree that the information presented on
                  or through the Services are for general informational purposes
                  only. We do not warrant the accuracy, completeness or
                  ...
                  on such materials by you or any other visitor to our Services,
                ...
                <li>
                  ...
                  responses to questions and other content are solely the
                  opinions and the responsibility of the person or entity
                  providing those materials. These materials do not necessarily
                  reflect our opinion. We are not responsible, or liable to you
                  or any third party, for the content or accuracy of any
            ...
            <li>
              ...
              <ol type="a">
                <li>
                  To the fullest extent permitted by applicable laws, you agree
                  to indemnify, defend and hold harmless us, as well as its
                  affiliates and service providers, and each of their respective
                  past, present and future officers, directors, members,
                  employees, consultants, representatives and agents, and each
                  of their respective successors and assigns ("Indemnified
                  ...
                  of settlement and costs of pursuing indemnification and
                  ...
                  contract or otherwise ("Claims"), including, but not limited
                  to, damages to property or personal injury, that are caused
                  by, arise out of or are related to: (a) your access and use of
                  any of our Services; (b) your violation of any term or
                  condition of this Agreement, the right of any third party, or
                  any other applicable law, rule, or regulation; (c) any other
                  party's access and use of any of our Services with your
                  assistance or using any device or account that you own or
                  control; (d) any dispute between you and (i) any other user of
                  any of the Services or (ii) any of your own customers or
                  users; and (e) your negligence or willful misconduct. You
                  agree to promptly notify us of any third-party Claims and
                  cooperate with the Indemnified Parties in defending such
                  Claims. You further agree that the Indemnified Parties shall
                  have the right to control the defense or settlement of any
            ...
            <li>
              ...
              <ol type="a">
                <li>
                  ...
                  SHALL THE INDEMNIFIED PARTIES OR ANY OF THEM BE LIABLE TO YOU
                  OR TO ANY OTHER PERSON FOR: (A) ANY INDIRECT, SPECIAL,
                  INCIDENTAL, PUNITIVE OR CONSEQUENTIAL DAMAGES OF ANY KIND,
                  INCLUDING DAMAGES FOR LOST PROFITS, BUSINESS INTERRUPTION,
                  LOSS OF DATA, LOSS OF GOODWILL, WORK STOPPAGE, ACCURACY OF
                  RESULTS, OR COMPUTER FAILURE OR MALFUNCTION; (B) ANY
                  SUBSTITUTE GOODS, SERVICES OR TECHNOLOGY; (C) ANY AMOUNT, IN
                  THE AGGREGATE, IN EXCESS OF ONE-HUNDRED ($100) DOLLARS; OR (D)
                  ANY MATTER BEYOND THE REASONABLE CONTROL OF THE INDEMNIFIED
                  PARTIES OR ANY OF THEM. SOME JURISDICTIONS DO NOT ALLOW THE
                  EXCLUSION OR LIMITATION OF INCIDENTAL OR CONSEQUENTIAL OR
                  CERTAIN OTHER DAMAGES, SO THE ABOVE LIMITATIONS AND EXCLUSIONS
            ...
            <li>
              ...
              <ol type="a">
                <li>
                  Governing Law: You agree that the laws of the State of New
                  York, without regard to principles of conflict of laws, govern
                  this Agreement and any Dispute between you and us. You further
                  agree that each of our Service shall be deemed to be based
                  solely in the State of New York, and that although Service may
                  ...
                  forum outside the State of New York. The parties acknowledge
                  that this Agreement evidences interstate commerce. Any
                  arbitration conducted pursuant to this Agreement shall be
                  governed by the Federal Arbitration Act. You agree that the
                  federal and state courts of New York County, New York are the
                  proper forum for any appeals of an arbitration award or for
                ...
                <li>
                  ...
                  acts or omissions for which you may contend that we are
                  liable, including, but not limited to, any claim or
                  controversy as to arbitrability ("**Dispute**"), shall be
                  finally and exclusively settled by arbitration under the JAMS
                  Optional Expedited Arbitration Procedures. You understand that
                  you are required to resolve all Disputes by binding
                  arbitration. The arbitration shall be held on a confidential
                  basis before a single arbitrator, who shall be selected
                  pursuant to JAMS rules, including where applicable the JAMS'
                  Mass Arbitration Procedures and Guidelines. The arbitration
                  will be held in New York, New York, unless you and we both
                  agree to hold it elsewhere. Unless we agree otherwise, the
                  arbitrator may not consolidate your claims with those of any
                  other party. Any judgment on the award rendered by the
                  arbitrator may be entered in any court of competent
                  jurisdiction. If for any reason a claim by law or equity must
                  proceed in court rather than in arbitration you agree to waive
                  any right to a jury trial and any claim may be brought only in
                  a Federal District Court or a New York state court located in
            ...
            <li>
              ...
              <ol type="a">
                <li>
                  ...
                  supersedes any and all prior or contemporaneous written and
                  oral agreements, communications and other understandings (if
                ...
                <li>
                  ...
                  consent. Any attempt by you to assign or transfer this
                  Agreement without our prior written consent shall be null and
                  void. We may freely assign or transfer this Agreement. Subject
                ...
                <li>
                  ...
                  or regulation of any local, state, or federal government
                  agency, such provision will be changed and interpreted to
                  accomplish the objectives of the provision to the greatest
                  extent possible under any applicable law and the validity or
                  enforceability of any other provision of this Agreement shall
                  not be affected.
                </li>
              </ol>
            </li>
