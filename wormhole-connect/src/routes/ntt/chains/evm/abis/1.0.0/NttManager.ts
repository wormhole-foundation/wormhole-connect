...
export declare namespace TransceiverRegistry {
  ...
  export type TransceiverInfoStructOutput = [boolean, boolean, number] & {
    registered: boolean;
    enabled: boolean;
    index: number;
  };
...
export interface NttManagerInterface extends utils.Interface {
  functions: {
    ...
    'getTransceiverInfo()': FunctionFragment;
...
export interface NttManager extends BaseContract {
  ...
  functions: {
    ...
    getTransceiverInfo(
      overrides?: CallOverrides,
    ): Promise<[TransceiverRegistry.TransceiverInfoStructOutput[]]>;
  ...
  estimateGas: {
    ...
    getTransceiverInfo(overrides?: CallOverrides): Promise<BigNumber>;
