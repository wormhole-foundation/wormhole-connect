...
export const MsgForceTransfer = {
  ...
  fromJSON(object: any): MsgForceTransfer {
    return {
      ...
      transferFromAddress: isSet(object.transferFromAddress)
        ? String(object.transferFromAddress)
        : '',
      transferToAddress: isSet(object.transferToAddress)
        ? String(object.transferToAddress)
        : '',
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<MsgForceTransfer>, I>>(
    object: I,
  ): MsgForceTransfer {
    const message = createBaseMsgForceTransfer();
    message.sender = object.sender ?? '';
...
export const MsgForceTransferResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgForceTransferResponse>, I>>(
    _: I,
  ): MsgForceTransferResponse {
    const message = createBaseMsgForceTransferResponse();
    return message;
...
export class MsgClientImpl implements Msg {
  ...
  ChangeAdmin(request: MsgChangeAdmin): Promise<MsgChangeAdminResponse> {
    ...
    return promise.then((data) =>
      MsgChangeAdminResponse.decode(new _m0.Reader(data)),
    );
  }
  SetDenomMetadata(
    request: MsgSetDenomMetadata,
  ...
  ForceTransfer(request: MsgForceTransfer): Promise<MsgForceTransferResponse> {
    ...
    return promise.then((data) =>
      MsgForceTransferResponse.decode(new _m0.Reader(data)),
    );
  }
}
