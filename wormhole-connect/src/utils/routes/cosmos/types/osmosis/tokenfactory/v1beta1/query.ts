...
export const QueryDenomAuthorityMetadataRequest = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<QueryDenomAuthorityMetadataRequest>, I>,
  >(object: I): QueryDenomAuthorityMetadataRequest {
    const message = createBaseQueryDenomAuthorityMetadataRequest();
...
export const QueryDenomAuthorityMetadataResponse = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<QueryDenomAuthorityMetadataResponse>, I>,
  >(object: I): QueryDenomAuthorityMetadataResponse {
    const message = createBaseQueryDenomAuthorityMetadataResponse();
    message.authorityMetadata =
...
export class QueryClientImpl implements Query {
  ...
  DenomAuthorityMetadata(
    ...
    return promise.then((data) =>
      QueryDenomAuthorityMetadataResponse.decode(new _m0.Reader(data)),
    );
  }
  DenomsFromCreator(
    request: QueryDenomsFromCreatorRequest,
    ...
    return promise.then((data) =>
      QueryDenomsFromCreatorResponse.decode(new _m0.Reader(data)),
    );
  }
}
