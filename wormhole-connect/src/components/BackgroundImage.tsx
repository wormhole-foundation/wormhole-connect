  ...
  return (
    <div className={classes.container}>
      <svg width="1440" height="1170" viewBox="0 0 1440 1170" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="108.5" cy="220.5" r="398.5" fill="url(#paint0_radial_1900_86296)" fillOpacity="0.5"/>
        </g>
        <g opacity="0.04">
        ...
        <circle cx="1079.5" cy="501.5" r="437.5" fill="url(#paint1_radial_1900_86296)" fillOpacity="0.5"/>
        </g>
        <g filter="url(#filter2_b_1900_86296)">
        <circle cx="1397.5" cy="683.5" r="437.5" fill="url(#paint2_radial_1900_86296)" fillOpacity="0.7"/>
        </g>
        </g>
        <defs>
        <filter id="filter0_b_1900_86296" x="-314" y="-202" width="845" height="845" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
        ...
        <filter id="filter1_b_1900_86296" x="618" y="40" width="923" height="923" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
        <feFlood floodOpacity="0" result="BackgroundImageFix"/>
        <feGaussianBlur in="BackgroundImageFix" stdDeviation="12"/>
        <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_1900_86296"/>
        <feBlend mode="normal" in="SourceGraphic" in2="effect1_backgroundBlur_1900_86296" result="shape"/>
        </filter>
        <filter id="filter2_b_1900_86296" x="936" y="222" width="923" height="923" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
        <feFlood floodOpacity="0" result="BackgroundImageFix"/>
        <feGaussianBlur in="BackgroundImageFix" stdDeviation="12"/>
        <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_1900_86296"/>
        <feBlend mode="normal" in="SourceGraphic" in2="effect1_backgroundBlur_1900_86296" result="shape"/>
