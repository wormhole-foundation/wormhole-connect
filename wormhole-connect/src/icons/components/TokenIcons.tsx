      ...
      return (
        <div className={classes.container}>
          ...
          >
            <path
              fill="#F0B90B"
              d="M20.302 0L9.68 6.127l3.906 2.263 6.717-3.863L27.02 8.39l3.906-2.263L20.303 0zm6.718 11.59l3.906 2.264v4.527l-6.718 3.863v7.727l-3.905 2.263-3.906-2.263v-7.727L9.679 18.38v-4.527l3.906-2.264 6.717 3.864 6.718-3.864z"
            ></path>
            <path
              fill="#F0B90B"
            ...
            <path
              fill="#F0B90B"
              d="M26.981 31.57l6.718-3.863V19.98l3.906-2.263v12.254l-10.624 6.127V31.57zM33.7 12.254L29.792 9.99 33.7 7.727l3.906 2.263v4.527L33.7 16.781v-4.527zM16.397 37.737V33.21l3.905 2.263 3.906-2.263v4.527L20.303 40l-3.906-2.263zm-2.812-9.367l-3.906-2.263v-4.526l3.906 2.263v4.527zm6.717-16.116L16.397 9.99l3.905-2.263 3.906 2.263-3.905 2.264zm-9.49-2.264l-3.906 2.264v4.527L3 14.517V9.99l3.906-2.263 3.906 2.263z"
            ></path>
            <path
              fill="#F0B90B"
              d="M3 17.717l3.906 2.264v7.726l6.718 3.864v4.527L3 29.97V17.717z"
            ></path>
          </svg>
        </div>
      );
