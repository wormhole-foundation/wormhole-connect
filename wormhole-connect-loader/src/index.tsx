...
> {
  componentDidMount() {
    ...
    script.src = "https://www.unpkg.com/@wormhole-foundation/wormhole-connect@0.0.10/dist/main.js";
    script.async = true;

    const link = document.createElement("link");
    link.href = "https://www.unpkg.com/@wormhole-foundation/wormhole-connect@0.0.10/dist/main.css";
